...
/**
 * JPA Specifications for DdnContributionMapping filtering
 */
public class DdnMappingSpecification {

    private static final String TRANSACTION_DATE_TIME = "transactionDateTime";

    private DdnMappingSpecification() {
        // Private constructor to prevent instantiation
    }

    /**
     * Create specification for filtering DDN contribution mappings
     */
    public static Specification<DdnContributionMapping> filterBy(
            String utr,
            String masterVa,
            String vaAccount,
            String folio,
    ...
    private static void addStringEqualPredicate(
            ...
            Root<DdnContributionMapping> root,
